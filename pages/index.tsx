...
const Home: NextPage = () => {
  return (
    ...
    <Header />
  <div className='flex justify-center items-center bg-yellow-400 border-y border-black
  py-10 lg:py-0'>
    <div className='px-10 space-y-5'> 
      ...
      Aliquid recusandae eos dolorum temporibus quos numquam provident rerum id,
      aperiam itaque.</h2>
    </div>
